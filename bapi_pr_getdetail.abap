...
cl_demo_output=>write_data( gt_pritemtext ).
cl_demo_output=>write_data( gt_prheadertext ).
cl_demo_output=>write_data( gt_extensionout ).
cl_demo_output=>write_data( gt_allversions ).
cl_demo_output=>write_data( gt_prcomponents ).
cl_demo_output=>write_data( gt_serialnumbers ).
cl_demo_output=>write_data( gt_serviceoutline ).
cl_demo_output=>write_data( gt_servicelines ).
cl_demo_output=>write_data( gt_servicelimit ).
